...
::: important 本章没有需要动手完成的任务，你只需要阅读本章内容，理解前后端分离架构的基本概念即可。
:::
...
::: tip RESTful API 或 GraphQL 是什么？我应该如何选择？
GraphQL 和 RESTful 均为前后端通信规范，用于数据查询的网站架构设计。GraphQL 由 Facebook 于 2012 年内部开发，2015 年开源，旨在替代 RESTful 架构体系。尽管两者都基于 HTTP 进行数据交互，但存在显著差异：GraphQL 允许客户端在请求中精确指定所需数据，而 RESTful 则要求先在服务端预定义 API。因此，它们既有共同点，也有各自的独特之处。

更详细的对比可以参考 [GraphQL vs RESTful API：如何选择？](https://apifox.com/apiskills/graphql-vs-rest/)。

在本教程中，我们将主要使用 RESTful API 进行前后端通信，因为它更简单、更直观，同时也更符合传统的 Web 开发流程。
...
::: tip 前后端分离的挑战与新型架构
尽管前后端分离带来了诸多好处，但也存在一些挑战，如跨域请求、数据同步、状态管理等问题。这些挑战需要通过合理的架构设计和工具来解决，以确保前后端能够高效协作。

近年来由于 SEO、性能、安全性、SSR 等方面的需求，新型架构如 Serverless、微服务、Headless CMS 等逐渐兴起，为全栈开发提供了更多可能性。
:::
...
前后端技术还有很多不同的选择，如 React、Angular 等前端框架，Node.js、Spring Boot 等后端框架。 但在本课程中，我们选择了 Nuxt.js 和 FastAPI 作为主要技术栈，原因如下：
...
[Nuxt.js 官方文档](https://nuxt.com/docs/getting-started/introduction)
...
## 1.5 小结
在本章中，我们介绍了个人网站项目的背景、技术选型、功能规划以及学习目标。通过学习本课程，你将掌握全栈开发的核心技能，构建一个功能丰富、性能优异的个人网站。让我们一起开启这段精彩的旅程吧！